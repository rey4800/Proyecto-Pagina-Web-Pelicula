                    ...
                    <div class="border bg-white ">
                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="password" id="password"  name="password" placeholder="Contraseña"><br><br>
                            </div >
...
unset($__errorArgs, $__bag); ?>
                            <div class="d-grid gap-2 col-5 mx-auto text-white">
                                <input class="btn btn-info text-white" type="submit" value="INICIAR SESION"  ><br><br>
                            </div>
                            <hr>
                            <div class="text-center">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\13\movie\resources\views/auth/login.blade.php ENDPATH**/ ?>