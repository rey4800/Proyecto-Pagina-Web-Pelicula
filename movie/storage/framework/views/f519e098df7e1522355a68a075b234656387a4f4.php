    ...
    <div class="navbar  sticky-top navbar-light"  style="width:100%; height:70px;display:flex;">
      ...
      <div class="px-4 " style="float: right;">
        ...
        <?php if(auth()->check()): ?>
          ...
          <?php else: ?><!-- si no a iniciado sesion -->
        ...
        <?php endif; ?><!-- Fin de validacion si a iniciado sesion -->
        </nav>
      </div>  
    </div>
<?php $__env->stopSection(); ?>
    ...
    <table id="peliculas" class="table table-dark table-striped mt-4" >
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo e($alquiler->id); ?></td>
                    <td><?php echo e($alquiler->user_id); ?></td>
                    <td><?php echo e($alquiler->email); ?></td>
                    <td><?php echo e($alquiler->pelicula_id); ?></td>
                    <td><?php echo e($alquiler->titulo); ?></td>
                    <td><?php echo e($alquiler->cantidad); ?></td>
                    <td><?php echo e($alquiler->precio_al); ?></td>
                    <td><?php echo e($alquiler->fecha_i); ?></td>
                    <td><?php echo e($alquiler->fecha_f); ?></td>
                    <td><?php echo e($alquiler->fecha_e); ?></td>
                    <td><?php echo e($alquiler->multa); ?></td>
                    <td><?php echo e($alquiler->monto_multa); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/registros/alquileres.blade.php ENDPATH**/ ?>