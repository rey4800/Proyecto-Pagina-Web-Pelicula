...
<div class="container bg-white p-6 my-3  ">
  ...
  <!--div oculto para hacer las validaciones-->
            ...
            <div class="input-group mb-3">
              ...
              <input readonly="readonly" type="text" class="form-control" id="total" name="total" placeholder="" value="<?php echo e($pelicula->precio_com); ?>">
            </div><br>
...
<?php echo $__env->make('layouts.navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/buy/create.blade.php ENDPATH**/ ?>