                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="<?php echo e(url('peliculas/'.$pelicula->id.'/quitar')); ?>" method='get'>
                            ...
                            <button type="submit" class="formEliminar btn btn-danger my-2" style="width: 200px;" onclick="return confirm('¿Esta seguro de Quitar esta pelicula de las disponobles?')">Quitar</button>
                           </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\20\movie\resources\views/pelicula/index.blade.php ENDPATH**/ ?>