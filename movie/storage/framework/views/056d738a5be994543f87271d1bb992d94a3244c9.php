...
<div class="container my-5 ">
  <div class="row m-0 bg-dark">
    <div class="col-md-4 p-0">
      <img src="../<?php echo e($pelicula->imagen); ?>" style="width:100%;" >
      <div class="row px-3 pt-5 pb-4">
        <div class="col-8"><?php echo $__env->make('pelicula.like', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </div>
    ...
    <div class="col-md-8  p-0 bg-dark text-white">
      <div class="row w-100 p-3 text-center">
          <h2 class="text-white"> TITULO: <?php echo e($pelicula->titulo); ?></h2>
      </div>
      <div class="row px-3 pb-2">
        <h5><b>DESCRIPCION:</b> <?php echo e($pelicula->descripcion); ?></h5>
      </div>
      <div class="row px-3 pb-2 ">
        <div class="col-7"><h5><b>PRECIO DE VENTA:</b> $<?php echo e($pelicula->precio_com); ?></h5></div>
        <div class="col-5"><?php echo $__env->make('pelicula.compra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </div>
      </div>
      <div class="row px-3 pb-2">
        <div class="col-7"><h5><b>PRECIO DE RENTA:</b> $<?php echo e($pelicula->precio_al); ?></h5></div>
        <div class="col-5"><?php echo $__env->make('pelicula.rentar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>   </div>
      </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/pelicula/pelicula.blade.php ENDPATH**/ ?>