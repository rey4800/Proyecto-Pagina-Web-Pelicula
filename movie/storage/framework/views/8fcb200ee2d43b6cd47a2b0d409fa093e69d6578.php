...
<div class="container bg-white p-2 mt-3" style="width: 50%;" >
    ...
    <form action="../<?php echo e($pelicula->id); ?>" enctype="multipart/form-data" method="POST" >
        ...
        <div class="mb-3">
            ...
            <input id="titulo" name="titulo" type="text" class="form-control" value="<?php echo e($pelicula->titulo); ?>">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">descripcion</label>
            <textarea  id="descripcion" name="descripcion" type="text" class="form-control" value="hola" rows="3">
            <?php echo e($pelicula->descripcion); ?>
        ...
        <div class="mb-3">
            ...
            <input id="stock" name="stock" type="text" class="form-control" value="<?php echo e($pelicula->stock); ?>">
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Precio de alquiler</label>
            <input id="precio_al" name="precio_al" type="text" class="form-control" value="<?php echo e($pelicula->precio_al); ?>">
        </div>

        <div class="mb-3">
            <label for="" class="form-label">Precio de compra</label>
            <input id="precio_com" name="precio_com" type="text" class="form-control" value="<?php echo e($pelicula->precio_com); ?>">
        </div>
        <div class="mb-3">
            <label for="" class="form-label">Disponivilidad</label>
        ...
        <button type="submit" class="btn btm-primary" tabindex="9">Guardar</button>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\13\movie\resources\views/pelicula/edit.blade.php ENDPATH**/ ?>