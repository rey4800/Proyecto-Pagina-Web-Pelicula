...
<?php $__env->startSection('navbar'); ?>
    <div class="navbar  sticky-top navbar-light"  style="width:100%; height:70px;display:flex;">
      ...
      <div class="px-4 " style="float: right;">
        ...
        <?php if(auth()->check()): ?><!--Validamos que a iniciado sesionr-->
            <span><a class="a text-sm text-red underline">Bienvenido <b><?php echo e(auth()->user()->name); ?></b></a></span>
            <?php if(auth()->user()->role == 'admin'): ?><!--Validamos que se admin-->
            ...
            <?php endif; ?> <!-- fin de validacion admin-->
        ...
        <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($compra->user_id); ?></td>
                    <td><?php echo e($compra->email); ?></td>
                    <td><?php echo e($compra->pelicula_id); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/registros/compras.blade.php ENDPATH**/ ?>