...
<div class="container bg-white p-2 mt-3" style="width: 50%;" >
    ...
    <form action="../<?php echo e($pelicula->id); ?>" enctype="multipart/form-data" method="POST" >
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
        <div class="mb-3">
            <label for="" class="form-label">titulo</label>
            <input id="titulo" name="titulo" type="text" class="form-control" value="<?php echo e($pelicula->titulo); ?>" oninput="validacion.multi()">
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea  id="descripcion" name="descripcion" type="text" class="form-control"  rows="3" oninput="validacion.multi()"><?php echo e($pelicula->descripcion); ?></textarea>
        ...
        <div class="mb-3">
            ...
            <input id="stock" name="stock" type="number" class="form-control" value="<?php echo e($pelicula->stock); ?>" oninput="validacion.multi()">
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="precio_al" name="precio_al" type="number" step="0.001" class="form-control" value="<?php echo e($pelicula->precio_al); ?>" oninput="validacion.multi()">
        </div>
        ...
        <div class="mb-3">
            ...
            <input id="precio_com" name="precio_com" type="number" step="0.001" class="form-control" value="<?php echo e($pelicula->precio_com); ?>" oninput="validacion.multi()">
        </div>
...
<script  src="<?php echo e(asset('js/peli.js')); ?>"></script>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/pelicula/edit.blade.php ENDPATH**/ ?>