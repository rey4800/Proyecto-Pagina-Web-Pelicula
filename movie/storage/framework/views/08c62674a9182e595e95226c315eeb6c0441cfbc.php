    ...
    <div class="navbar  sticky-top navbar-light"  style="width:100%; height:70px;display:flex;">
      ...
      <div class="px-4 " style="float: right;">
        ...
        <?php if(auth()->check()): ?>
            ...
            <?php if(auth()->user()->role == 'admin'): ?> <!--Condicion que ayuda a identificar  que tipo de rol es el usuario-->
          ...
          <?php else: ?> <!--si el  usuario no esta  registrado le saldra en  el navbar esto-->
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\movie\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>