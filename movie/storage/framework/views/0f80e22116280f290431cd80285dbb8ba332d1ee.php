...
<form class=""action="../peliculas" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input id="precio_al" name="precio_al" type="text" class="form-control" tabindex="5">
    </div>

    <div class="mb-3">
        <label for="" class="form-label">Precio de compra</label>
        <input id="precio_com" name="precio_com" type="text" class="form-control" tabindex="6">
    </div>
    <div class="mb-3">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\13\movie\resources\views/pelicula/create.blade.php ENDPATH**/ ?>